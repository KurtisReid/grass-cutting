...
public abstract class AbstractApiBase {
    ...
    protected final static String baseUri = "https://api.soa-proxy.deere.com/platform/";
    protected final static String basePartnershipUri = "https://api.soa-proxy.deere.com/platform/partnerships";
